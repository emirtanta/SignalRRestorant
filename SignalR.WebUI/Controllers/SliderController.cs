...
namespace SignalR.WebUI.Controllers
{
    public class SliderController : Controller
    {
        ...
        public async Task<IActionResult> CreateSlider(CreateSliderDto createSliderDto)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:5271/api/Slider", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:5271/api/Slider/{id}");
        ...
        public async Task<IActionResult> UpdateSlider(UpdateSliderDto updateSliderDto)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:5271/api/Slider/", stringContent);
        ...
        {
            var client=_httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:5271/api/Slider/{id}");
